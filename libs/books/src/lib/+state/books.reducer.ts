...
export const booksAdapter = createListingAdapter<Book>()

export const initialState: BooksState = {
  ...booksAdapter.getListingInitialState(),
  currentId: null
};

const updateCurrentId = (state: BooksState, action: { payload: string }): BooksState => ({...state, currentId: action.payload})
